...
@Composable
private fun VerticalChoiceQuizNavBar(
    results: ChoiceQuizResultsState,
    currentIndex: Int,
    totalCount: Int,
    isOptionSelected: Boolean,
...
@Composable
private fun HorizontalChoiceQuizNavBar(
    results: ChoiceQuizResultsState,
    currentIndex: Int,
    totalCount: Int,
    isOptionSelected: Boolean,
...
@Composable
private fun VerticalContinueButton(
    showIcon: Boolean,
    enabled: Boolean,
    onClick: () -> Unit,
    modifier: Modifier = Modifier,
...
@Composable
private fun HorizontalContinueButton(
    text: String,
    showIcon: Boolean,
    enabled: Boolean,
    onClick: () -> Unit,
